...
<div class="hadith-meta">
  ...
  <span>Hadist 39 / 42</span>
</div>

<nav class="hadith-pager" aria-label="Page navigation">
  <a class="hadith-pager-link prev" href="{{ '/38/' | relative_url }}">Previous: Hadist 38</a>
  <span class="hadith-pager-spacer"></span>
  <a class="hadith-pager-link next" href="{{ '/40/' | relative_url }}">Next: Hadist 40</a>
</nav>
<section class='nass'><p lang='ar' dir='rtl' align=right><font size=6> الحديث التاسع والثلاثون <br />
<br />
