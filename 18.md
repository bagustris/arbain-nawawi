...
<div class="hadith-meta">
  ...
  <span>Hadist 18 / 42</span>
</div>

<nav class="hadith-pager" aria-label="Page navigation">
  <a class="hadith-pager-link prev" href="{{ '/17/' | relative_url }}">Previous: Hadist 17</a>
  <span class="hadith-pager-spacer"></span>
  <a class="hadith-pager-link next" href="{{ '/19/' | relative_url }}">Next: Hadist 19</a>
</nav>
<section class='nass'><p lang='ar' dir='rtl' align=right><font size=6> الحديث الثامن عشر <br />
<br />
<font color="#77216F">
