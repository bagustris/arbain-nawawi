...
<div class="hadith-meta">
  ...
  <span>Hadist 3 / 42</span>
</div>

<nav class="hadith-pager" aria-label="Page navigation">
  <a class="hadith-pager-link prev" href="{{ '/02/' | relative_url }}">Previous: Hadist 2</a>
  <span class="hadith-pager-spacer"></span>
  <a class="hadith-pager-link next" href="{{ '/04/' | relative_url }}">Next: Hadist 4</a>
</nav>
<section class='nass'><p lang='ar' dir='rtl' align=right><font size=6>  الحديث الثالث <br />
