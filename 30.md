...
<div class="hadith-meta">
  ...
  <span>Hadist 30 / 42</span>
</div>

<nav class="hadith-pager" aria-label="Page navigation">
  <a class="hadith-pager-link prev" href="{{ '/29/' | relative_url }}">Previous: Hadist 29</a>
  <span class="hadith-pager-spacer"></span>
  <a class="hadith-pager-link next" href="{{ '/31/' | relative_url }}">Next: Hadist 31</a>
</nav>
<section class='nass'><p lang='ar' dir='rtl' align=right><font size=6> الحديث الثلاثون <br />
<br />
