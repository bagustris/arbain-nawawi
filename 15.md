...
<div class="hadith-meta">
  ...
  <span>Hadist 15 / 42</span>
</div>

<nav class="hadith-pager" aria-label="Page navigation">
  <a class="hadith-pager-link prev" href="{{ '/14/' | relative_url }}">Previous: Hadist 14</a>
  <span class="hadith-pager-spacer"></span>
  <a class="hadith-pager-link next" href="{{ '/16/' | relative_url }}">Next: Hadist 16</a>
</nav>
<section class='nass'><p lang='ar' dir='rtl' align=right><font size=6> الحديث الخامس عشر <br />
<br />
<font color="#77216F">
