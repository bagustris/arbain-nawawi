...
<div class="hadith-meta">
  ...
  <span>Hadist 29 / 42</span>
</div>

<nav class="hadith-pager" aria-label="Page navigation">
  <a class="hadith-pager-link prev" href="{{ '/28/' | relative_url }}">Previous: Hadist 28</a>
  <span class="hadith-pager-spacer"></span>
  <a class="hadith-pager-link next" href="{{ '/30/' | relative_url }}">Next: Hadist 30</a>
</nav>
<section class='nass'><p lang='ar' dir='rtl' align=right><font size=6> الحديث التاسع والعشرون <br />
<br />
