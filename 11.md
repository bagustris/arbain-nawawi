...
<div class="hadith-meta">
  ...
  <span>Hadist 11 / 42</span>
</div>

<nav class="hadith-pager" aria-label="Page navigation">
  <a class="hadith-pager-link prev" href="{{ '/10/' | relative_url }}">Previous: Hadist 10</a>
  <span class="hadith-pager-spacer"></span>
  <a class="hadith-pager-link next" href="{{ '/12/' | relative_url }}">Next: Hadist 12</a>
</nav>
<section class='nass'><p lang='ar' dir='rtl' align=right><font size=6> الحديث الحادي عشر <br />
