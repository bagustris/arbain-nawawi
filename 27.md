...
<div class="hadith-meta">
  ...
  <span>Hadist 27 / 42</span>
</div>

<nav class="hadith-pager" aria-label="Page navigation">
  <a class="hadith-pager-link prev" href="{{ '/26/' | relative_url }}">Previous: Hadist 26</a>
  <span class="hadith-pager-spacer"></span>
  <a class="hadith-pager-link next" href="{{ '/28/' | relative_url }}">Next: Hadist 28</a>
</nav>
<section class='nass'><p lang='ar' dir='rtl' align=right><font size=6> الحديث السابع والعشرون <br />
<br />
