...
<div class="hadith-meta">
  ...
  <span>Hadist 24 / 42</span>
</div>

<nav class="hadith-pager" aria-label="Page navigation">
  <a class="hadith-pager-link prev" href="{{ '/23/' | relative_url }}">Previous: Hadist 23</a>
  <span class="hadith-pager-spacer"></span>
  <a class="hadith-pager-link next" href="{{ '/25/' | relative_url }}">Next: Hadist 25</a>
</nav>
<section class='nass'><p lang='ar' dir='rtl' align=right><font size=6> الحديث الرابع والعشرون <br />
<br />
<font color="#77216F">
