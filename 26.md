...
<div class="hadith-meta">
  ...
  <span>Hadist 26 / 42</span>
</div>

<nav class="hadith-pager" aria-label="Page navigation">
  <a class="hadith-pager-link prev" href="{{ '/25/' | relative_url }}">Previous: Hadist 25</a>
  <span class="hadith-pager-spacer"></span>
  <a class="hadith-pager-link next" href="{{ '/27/' | relative_url }}">Next: Hadist 27</a>
</nav>
<section class='nass'><p lang='ar' dir='rtl' align=right><font size=6> الحديث السادس والعشرون <br />
<br />
