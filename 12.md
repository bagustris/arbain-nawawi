...
<div class="hadith-meta">
  ...
  <span>Hadist 12 / 42</span>
</div>

<nav class="hadith-pager" aria-label="Page navigation">
  <a class="hadith-pager-link prev" href="{{ '/11/' | relative_url }}">Previous: Hadist 11</a>
  <span class="hadith-pager-spacer"></span>
  <a class="hadith-pager-link next" href="{{ '/13/' | relative_url }}">Next: Hadist 13</a>
</nav>
<section class='nass'><p lang='ar' dir='rtl' align=right><font size=6> الحديث الثانى عشر <br />
