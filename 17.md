...
<div class="hadith-meta">
  ...
  <span>Hadist 17 / 42</span>
</div>

<nav class="hadith-pager" aria-label="Page navigation">
  <a class="hadith-pager-link prev" href="{{ '/16/' | relative_url }}">Previous: Hadist 16</a>
  <span class="hadith-pager-spacer"></span>
  <a class="hadith-pager-link next" href="{{ '/18/' | relative_url }}">Next: Hadist 18</a>
</nav>
<section class='nass'><p lang='ar' dir='rtl' align=right><font size=6> الحديث السابع عشر <br />
<br />
<font color="#77216F">
