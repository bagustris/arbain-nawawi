...
<div class="hadith-meta">
  ...
  <span>Hadist 10 / 42</span>
</div>

<nav class="hadith-pager" aria-label="Page navigation">
  <a class="hadith-pager-link prev" href="{{ '/09/' | relative_url }}">Previous: Hadist 9</a>
  <span class="hadith-pager-spacer"></span>
  <a class="hadith-pager-link next" href="{{ '/11/' | relative_url }}">Next: Hadist 11</a>
</nav>
<section class='nass'><p lang='ar' dir='rtl' align=right><font size=6>< الحديث العاشر <br />
